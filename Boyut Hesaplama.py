...
Boyut = Tk()
Boyut.title("Boyut Hesaplama")
Boyut.geometry("500x100")
...
def  hacim1():
    ...
    def HSilindir():
        ...
        entryEskenarDortgen1 = Entry(EskenarDortgen)
        entryEskenarDortgen1.grid(row=0, column=1)
        entryEskenarDortgen2 = Entry(EskenarDortgen)
        entryEskenarDortgen2.grid(row=1, column=1)
        cEskenarDortgen= Button(EskenarDortgen, text="C", command= Ceskenardortgen)
        cEskenarDortgen.grid(row=0, column=3)
...
########################
boyut = Menu(Boyut)
Boyut.config(menu = boyut)

cevrE = Menu(boyut)
alaN = Menu(boyut)
haciM = Menu(boyut)

boyut.add_command(label="Çevre Hesaplama", command = cevre1)
boyut.add_command(label="Alan Hesaplama", command = alan1)
boyut.add_command(label="Hacim Hesaplama", command = hacim1)
